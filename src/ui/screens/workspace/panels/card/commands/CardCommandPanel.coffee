...
DeferCommandPanel    = React.createFactory(require 'ui/screens/workspace/panels/card/commands/panels/DeferCommandPanel')
PassCommandPanel     = React.createFactory(require 'ui/screens/workspace/panels/card/commands/panels/PassCommandPanel')
CompleteCommandPanel = React.createFactory(require 'ui/screens/workspace/panels/card/commands/panels/CompleteCommandPanel')
DeleteCommandPanel   = React.createFactory(require 'ui/screens/workspace/panels/card/commands/panels/DeleteCommandPanel')
