...
NotStartedBigPictureCard = React.createClass {

  displayName: 'NotStartedBigPictureCard'
  ...
  render: ->
    ...
    Card {className: 'big-picture-card notstarted', card: @props.card},
...
module.exports = NotStartedBigPictureCard
